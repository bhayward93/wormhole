...
export function ContractSummaryCard({
  contract,
}: MyContractsSummaryCardProps): JSX.Element {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        ...
        <p>
          <strong>factionSymbol:</strong> {contract.factionSymbol}
        </p>
        <p>
        ...
        <p>
          ...
          {contract.fulfilled ? 'Fulfilled' : 'Unfulfilled'}
        </p>
        <p>
          <strong>Accepted:</strong>{' '}
          {contract.accepted ? 'Accepted' : 'Available'}
        </p>
        <p>
